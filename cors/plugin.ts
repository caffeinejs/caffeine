...
/**
 * Builder methods contributed by {@link corsPlugin}.
 */
export interface CorsPluginExt {
  /**
 ...
 * `createWebApplication(...).extend(corsPlugin())` then call `.cors()` so the adapter registers
 ...
 */
export function corsPlugin(): Plugin<CorsPluginExt> {
