...
/** The CORS feature's slice of the configuration tree. */
 ...
 *
 * Import it into an application schema — `$t.Object({ app: $t.Object({ cors: corsConfigSchema }) })` — rather
 * than restating it, then point the feature at that location with `c.config(x => x.app.cors)`.
 */
