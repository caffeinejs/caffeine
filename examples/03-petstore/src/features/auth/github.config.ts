...
export const githubConfig = {
  ...
  callbackURL:
    process.env.PETSTOREDEMO_AUTH_GITHUB_CALLBACK_URL ??
    "http://localhost:9999/login/github/callback",
  homepage:
    process.env.PETSTOREDEMO_AUTH_GITHUB_HOMEPAGE ?? "http://localhost:9999/",
  ...
  sessionSecret:
    process.env.PETSTOREDEMO_AUTH_GITHUB_SESSION_SECRET ??
    "petstore-dev-session-secret-32-chars!!",
} as const;
