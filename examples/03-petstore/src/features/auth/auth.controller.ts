import { Controller, ErrHTTPUnauthorized, Params, Post, Schema } from '@caffeinejs/http'
...
// The schema is the single source of truth: the request type comes straight out of it.
type LoginDTO = InferSchema<typeof loginSchema>
