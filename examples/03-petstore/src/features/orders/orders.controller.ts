...
export class OrdersController {
  ...
  @Status(201)
  @Authorize()
  @Schema({ body: createOrderSchema, response: { 201: orderSchema, 404: apiErrorSchema, 422: apiErrorSchema } })
  @Params([$p.body()])
  @Operation({
  ...
  @Get('/:id')
  @Authorize()
  @Schema({ params: orderIdParamSchema, response: { 200: orderSchema, 404: apiErrorSchema } })
  @Params([$p.param('id')])
