...
describe('isConstructable', function () {
  ...
  it('should return false for null', function () {
    expect(isConstructable(null))
      .toBe(false)
  })

  it('should return false for undefined', function () {
    expect(isConstructable(undefined))
      .toBe(false)
  })

  it('should return false for a string', function () {
    expect(isConstructable('hello'))
      .toBe(false)
  })

  it('should return false for a number', function () {
    expect(isConstructable(42))
      .toBe(false)
  })
  ...
  it('should return false for an instance of a class', function () {
    class Qux {}
    expect(isConstructable(new Qux()))
      .toBe(false)
  })
})
