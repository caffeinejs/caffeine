...
/**
 * Records the tokens of guards that run on every route. Does not bind the classes — they must already
 ...
 *
 * A guard listed more than once for a route runs once, at its first position.
 */
