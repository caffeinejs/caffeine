...
import { CatchBy, type Context, Controller, ErrConfiguration, ErrorHandler, Get, createWebApplication, fastifyAdapterFactory } from '../../index.js'
...
describe('@CatchBy with an unregistered handler', () => {
