...
import type { RoutesOf, VarsOf } from './types.js'
 ...
 */
export function blend<const RS extends ReadonlyArray<Router<any, any, any, any>>>(
  ...routers: RS
): Router<VarsOf<RS[number]>, undefined, '', RoutesOf<RS[number]>> {
  ...
  return new Router<VarsOf<RS[number]>>().mount(...routers) as Router<
    VarsOf<RS[number]>,
    undefined,
    '',
    RoutesOf<RS[number]>
